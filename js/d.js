...
cell6.innerHTML = pg;
  ...
  document.getElementById("bck").style.visibility = "visible";
          ...
          document.getElementById('Author').innerHTML=level[author.length-1];
          document.getElementById('Title').innerHTML=title[title.length-1];
          document.getElementById('CName').innerHTML=stname[cname.length-1];
          document.getElementById('Place').innerHTML=spname[place.length-1];
          document.getElementById('Year').innerHTML=spname[year.length-1];
          document.getElementById('Page').innerHTML=spname[page.length-1];
